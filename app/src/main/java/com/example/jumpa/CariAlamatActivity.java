...
public class CariAlamatActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchText = findViewById(R.id.et_cari);
    ...
    private void geoLocate(){
        ...
        Geocoder geocoder = new Geocoder(CariAlamatActivity.this);
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(CariAlamatActivity.this);
    }
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(CariAlamatActivity.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
